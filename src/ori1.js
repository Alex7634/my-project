...
document.addEventListener("DOMContentLoaded", function() {
    ...
    //let palette = [ 0, 0, 0, 0 ];
    let palette = [ 15, 5, 3, 4 ];

    // Все устройства компьютера
    let memory = new Uint8Array(65536);
    let keyboard = new Keyboard();
    let video = new Video(canvas, memory, palette);
    ...
    cpu.writeMemory = function(addr, byte) {
        ...
        switch (addr & 0xff00) {
            ...
            case 0xf700:
                break;
            // $F800:        orSelectScreenMode(Val);
            case 0xf800:
                break;
            // $F900:        orSelectPage(Val);
            case 0xf900:
                break;
